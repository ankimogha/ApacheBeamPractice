...
public class ParquetIOExample {
    public static void main(String[] args) {
        ...
        PCollection<GenericRecord> pOutput=p.apply(TextIO.read().from("/home/knoldus/IdeaProjects/ApacheBeamPractice5/user.csv"))
                .apply(MapElements.via(new ConvertCsvToGeneric()))
                .setCoder(AvroCoder.of(GenericRecord.class, schema));

        pOutput.apply(FileIO.<GenericRecord>write().via(ParquetIO.sink(schema)).to("/home/knoldus/IdeaProjects/ApacheBeamPractice5/parquetexample")
