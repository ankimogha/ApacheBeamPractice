...
//		Step 1 : Read csv file.
        ...
        PCollection<String> fileInput= pipeline.apply(TextIO.read().from("/home/knoldus/IdeaProjects/ApacheBeamPractice8/user_order.csv"));
...
//		Step 4 : Convert PCollection<Row> to PCollection<String>
        ...
        pOutput.apply(TextIO.write().to("/home/knoldus/IdeaProjects/ApacheBeamPractice8/sql_count_output").withNumShards(1).withSuffix(".csv"));
