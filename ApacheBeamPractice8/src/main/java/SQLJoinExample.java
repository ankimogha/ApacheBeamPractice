...
//		Step 1 : Read csv file.
        ...
        PCollection<String> order= pipeline.apply(TextIO.read().from("/home/knoldus/IdeaProjects/ApacheBeamPractice8/user_order.csv"));
        PCollection<String> user= pipeline.apply(TextIO.read().from("/home/knoldus/IdeaProjects/ApacheBeamPractice8/p_user.csv"));
...
//		Step 4 : Convert PCollection<Row> to PCollection<String>
        ...
        pOutput.apply(TextIO.write().to("/home/knoldus/IdeaProjects/ApacheBeamPractice8/sql_join_output").withNumShards(1).withSuffix(".csv"));
