...
public class GroupByKeyExample {
    public static void main(String[] args) {
        ...
        // Step 1
        PCollection<String> pCustOrderList = p.apply(TextIO.read().from("/home/knoldus/IdeaProjects/ApacheBeamPractice3/GroupByKey_data.csv"));
        ...
        output.apply(TextIO.write().to("/home/knoldus/IdeaProjects/ApacheBeamPractice3/group_by_output").withHeader("Id,Amount").withNumShards(1).withSuffix(".csv"));
