...
public class RightJoinExample {
    public static void main(String[] args) {
        ...
        PCollection<KV<String,String>> pOrderCollection = p.apply(TextIO.read().from("/home/knoldus/IdeaProjects/ApacheBeamPractice4/user_order.csv"))
                .apply(ParDo.of(new RightOrderParsing()));

        PCollection<KV<String,String>> pUserCollection = p.apply(TextIO.read().from("/home/knoldus/IdeaProjects/ApacheBeamPractice4/p_user.csv"))
        ...
        output.apply(TextIO.write().to("/home/knoldus/IdeaProjects/ApacheBeamPractice4/right_join_example").withNumShards(1).withSuffix(".csv"));
        p.run();
