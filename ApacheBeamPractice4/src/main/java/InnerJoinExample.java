...
public class InnerJoinExample {
    public static void main(String[] args) {
        ...
        PCollection<KV<String,String>> pOrderCollection = pipeline.apply(TextIO.read().from("/home/knoldus/IdeaProjects/ApacheBeamPractice4/user_order.csv"))
                .apply(ParDo.of(new OrderParsing()));

        PCollection<KV<String,String>> pUserCollection = pipeline.apply(TextIO.read().from("/home/knoldus/IdeaProjects/ApacheBeamPractice4/p_user.csv"))
        ...
        output.apply(TextIO.write().to("/home/knoldus/IdeaProjects/ApacheBeamPractice4/cogroup_by_key").withNumShards(1).withSuffix(".csv"));
        pipeline.run();
    }
}
